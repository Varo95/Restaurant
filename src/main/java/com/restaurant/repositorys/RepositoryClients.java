 ...
 */
  ...
  /**
   * Funci�n que devuelve un cliente el cual buscamos por el dni
   * @param dni cliente
   * @return cliente
   */
...
/**
 * Funci�n que devuelve un true o un folse si a o no aniadido un cliente
 * @param c cliente
...
/**
 * Funci�n que devuelve un true o un folse si a o no eliminado un cliente
 * @param dni cliente
